...
import ProductFilterComponent from "./product_filter";
...
const AddProductDialog: React.FC<FormProps> = ({ open, onCancel, onSuccess }) => {
    ...
    return (
        <Modal title="Thêm sản phẩm" open={open} onCancel={onCancel} footer={null} style={{
            ...
            <Flex vertical gap={30}>
                <ProductFilterComponent onChange={(search: string, brand_uids: string[], status_uids: string[]) => {
