...
@Entity
@Table(name = "inventory_export_items", uniqueConstraints = @UniqueConstraint(columnNames = { "export_uid",
        "product_uid" }))
@AllArgsConstructor
@NoArgsConstructor
@Data
...
@Builder
public class InventoryExportItemEntity extends AuditEntity {
    @Id
    ...
    @ManyToOne
    @JoinColumn(name = "export_uid", nullable = false)
    private InventoryExportEntity export;
